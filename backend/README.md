...
## Project Structure
    ...
    ├── test_inventory_mana_38108  # Django project configurations
...
1. Clone this repo and `cd test_inventory_mana_38108`
...
2. Clone this repo and `cd test_inventory_mana_38108`
